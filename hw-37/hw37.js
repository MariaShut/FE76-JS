...
// Задание 1.
// Изучить материалы по ссылкам

/* 
 Big O notation - оценка сложности алгоритма  
...
// Задание 2. Решить задачи с массивом films.

// ВСЕ ДАННЫЕ ДОЛЖНЫ БЫТЬ ПРОТИПИЗИРОВАНЫ (ДОБАВЛЯЕМ TYPESCRIPT)
...
5. Создать функцию, которая принимает массив фильмов и год выхода фильма. А
...
фильмами, где строка входит в название фильма или в его сюжет.
